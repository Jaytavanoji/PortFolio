...
const DEFAULT_TEXTS = ["BACKENDS.", "AI SYSTEMS.", "FAST APIS.", "SOLUTIONS."];
...
const DEFAULT_WIPE_COLOR = "#FFFFFF";
const DEFAULT_REVEAL_COLOR = "#6E1A2B";
...
export function TextRevealBlur({
  ...
  const holdDuration = transition.delay ?? DEFAULT_TRANSITION.delay ?? 1.5;
    ...
    >
      ...
      <span
        ...
        style={{
          ...
          lineHeight: font.lineHeight ?? 0.95,
