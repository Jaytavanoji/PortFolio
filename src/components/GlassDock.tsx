...
const MorphingIcon = ({ type, isActive, onClick, onMouseEnter }: { type: string, isActive: boolean, onClick: () => void, onMouseEnter?: () => void }) => {
    ...
    const commonBtnClass = cn(
        "relative flex items-center justify-center w-full h-full text-white/80 hover:text-white transition-colors",
        isActive ? "text-white" : ""
    );

    if (type === 'home') {
        return (
            <button ref={buttonRef} onClick={onClick} onMouseEnter={handleMouseEnter} className={commonBtnClass}>
    ...
    (
        ...
        return (
            ...
            >
                <div
                    className={cn(
                        "glass-dock relative flex gap-3 sm:gap-4 items-center px-5 sm:px-6 py-3 sm:py-3.5 rounded-full",
                        "border border-white/20 bg-white/[0.08]",
                        "backdrop-blur-2xl backdrop-saturate-150",
                        "shadow-[0_20px_50px_rgba(0,0,0,0.7),inset_0_1px_1.5px_rgba(255,255,255,0.35),inset_0_-1px_1px_rgba(0,0,0,0.3)] justify-center",
                        dockClassName
                    )}
                    onMouseLeave={() => {
                ...
                >
                            ...
                            >
                                <div
                                    className={cn(
                                        ...
                                        'bg-[#09090B]/85 text-white font-medium',
                                        'backdrop-blur-xl border border-white/20',
                                        'shadow-[0_10px_30px_rgba(0,0,0,0.8),inset_0_1px_1px_rgba(255,255,255,0.3)] flex items-center justify-center',
                                        'min-w-[70px]'
                                    )}
                                >
                    ...
                    {items.map((el, index) => {
                        ...
                        let mappedType = type;
                        if (type === 'about') mappedType = 'marker';
                        else if (type === 'work' || type === 'projects') mappedType = 'blog';
                        else if (type === 'contact') mappedType = 'email';
                        else if (type === 'skills') mappedType = 'github';

                        const isAnimated = ['home', 'blog', 'marker', 'email', 'linkedin', 'x', 'github'].includes(mappedType);
                        ...
                        return (
                            <div
                                ...
                                onClick={handleClick}
                                className="relative w-10 h-10 flex items-center justify-center cursor-pointer rounded-full transition-all duration-200 hover:bg-white/15"
                                role="button"
                                tabIndex={0}
                                onKeyDown={(e) => {
